...
function LateIconBox({ children }: { children: ReactNode }) {
  return <div className="flex h-[40px] w-[40px] shrink-0 items-center justify-center rounded-[10px] bg-[#FFF4D8] text-[#FFA726]">{children}</div>
}

function LateIllustration({ children }: { children: ReactNode }) {
  return <div className="flex h-[82px] w-[88px] shrink-0 items-center justify-center rounded-[12px] bg-[#FFF9EF] text-[#F28C00]">{children}</div>
}
...
function SignCard({ icon, title, text }: { icon: ReactNode; title: string; text: string }) {
  return (
    <article className="flex min-h-[116px] items-start gap-4 rounded-[16px] border border-[#E4E8EB] bg-white px-5 py-4 shadow-[0_6px_16px_rgba(0,0,0,0.04)]">
      <div className="flex h-[68px] w-[68px] shrink-0 items-center justify-center rounded-full bg-[#F8F8F8] text-[#21A7A2]">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1.5 whitespace-pre-line text-[13.2px] font-medium leading-[1.3] text-[#6D7A86]">{text}</p>
      </div>
    </article>
  )
}
...
function RiskRow({ icon, title, text }: { icon: ReactNode; title: string; text: string }) {
  return (
    <article className="flex min-h-[62px] items-center gap-2.5 rounded-[12px] border border-[#E4E8EB] bg-white px-3 py-2 shadow-[0_5px_14px_rgba(0,0,0,0.04)]">
      <LateIconBox>{icon}</LateIconBox>
      <div className="min-w-0 flex-1">
        <h3 className="text-[13.5px] font-bold leading-tight text-[#18324A]">{title}</h3>
        <p className="mt-0.5 text-[11px] font-medium leading-[1.15] text-[#6D7A86]">{text}</p>
      </div>
      <span className="shrink-0 text-[22px] font-light leading-none text-[#FFA726]">›</span>
    </article>
  )
}
...
function ComplicationCard({ icon, title, text, note }: { icon: ReactNode; title: string; text: string; note: string }) {
  return (
    <article className="flex min-h-[130px] gap-3.5 rounded-[16px] border border-[#E4E8EB] bg-white px-4 py-3 shadow-[0_6px_16px_rgba(0,0,0,0.04)]">
      <LateIllustration>{icon}</LateIllustration>
      <div className="min-w-0 flex-1">
        <h3 className="text-[16.5px] font-bold leading-tight text-[#F28C00]">{title}</h3>
        <p className="mt-1.5 whitespace-pre-line text-[12.3px] font-medium leading-[1.24] text-[#18324A]">{text}</p>
        <div className="mt-1.5 flex gap-2 rounded-[10px] bg-[#EAF8F7] px-2.5 py-1.5">
          <div className="mt-[1px] flex h-[16px] w-[16px] shrink-0 items-center justify-center rounded-full bg-white text-[#21A7A2]"><InfoIcon className="h-3 w-3" /></div>
          <p className="whitespace-pre-line text-[10.5px] font-medium leading-[1.16] text-[#6D7A86]">{note}</p>
        </div>
      </div>
    </article>
  )
...
function EarlyContent() {
  return (
    <>
      <div className="absolute left-[35px] top-[88px] h-[990px] w-[430px] rounded-[22px] bg-white px-7 py-7 shadow-[0_12px_35px_rgba(0,0,0,0.08)]">
        <div>
        ...
        <div className="relative mt-5 h-[650px]">
          ...
          <div className="absolute right-0 top-0 h-[565px] w-[282px] overflow-hidden rounded-[24px] bg-[#FFF4E6]">
      ...
      <div className="absolute right-[35px] top-[88px] h-[990px] w-[500px] rounded-[22px] bg-white px-[34px] py-7 shadow-[0_12px_35px_rgba(0,0,0,0.08)]">
        ...
        <div className="mt-4 flex gap-4 rounded-[16px] border-[1.5px] border-[#F6B24B] bg-[#FFF9EF] px-5 py-4">
        ...
        <div className="mt-3 flex items-center gap-3 rounded-[12px] bg-[#EAF8F7] px-[18px] py-3">
...
function LateContent() {
  return (
    <>
      <div className="absolute left-[35px] top-[88px] h-[990px] w-[380px] rounded-[22px] bg-white px-6 py-7 text-center shadow-[0_12px_35px_rgba(0,0,0,0.08)]">
        <div className="mx-auto flex h-[38px] w-[38px] items-center justify-center rounded-full bg-[#FFA726] text-[20px] font-bold leading-none text-white">2</div>
        <h2 className="mt-2 text-[16px] font-bold leading-tight text-[#FFA726]">Поздние осложнения</h2>
        <p className="mt-2 text-[14px] font-medium leading-[1.32] text-[#6D7A86]">При длительном дефиците витамина D<br />могут развиваться серьёзные последствия,<br />влияющие на здоровье ребёнка<br />в будущем.</p>

        <div className="relative mx-auto mt-4 h-[285px] w-[300px] overflow-hidden rounded-[24px] bg-[#FFF4E6]">
          ...
          <div className="absolute inset-x-0 bottom-0 h-[96px] bg-gradient-to-t from-white via-white/80 to-transparent" />
        </div>
        ...
        <div className="mt-4 text-left">
          ...
          <div className="relative h-[8px] rounded-full bg-[#E4E8EB]">
            ...
            <div className="absolute left-[86%] top-1/2 h-[20px] w-[20px] -translate-y-1/2 rounded-full border-[5px] border-white bg-[#FFA726] shadow-[0_6px_14px_rgba(255,167,38,0.35)]" />
          </div>
        </div>

        <h3 className="mt-4 text-left text-[17px] font-bold leading-tight text-[#18324A]">Ключевые зоны риска</h3>
      ...
      <div className="absolute right-[35px] top-[88px] h-[990px] w-[560px] rounded-[22px] bg-white px-7 py-7 shadow-[0_12px_35px_rgba(0,0,0,0.08)]">
        <h2 className="text-[21px] font-bold leading-[1.24] text-[#18324A]">Что может произойти при длительном<br />дефиците витамина D у младенца</h2>

        <div className="mt-4 grid gap-2.5">
          <ComplicationCard
            icon={<BoneIcon className="h-11 w-11" />}
            title="Рахит"
          ...
          />
          <ComplicationCard
            icon={<SkeletonIcon className="h-11 w-11" />}
          ...
          />
          <ComplicationCard
            icon={<DevelopmentIcon className="h-11 w-11" />}
          ...
          />
          <ComplicationCard
            icon={<ImmuneIcon className="h-11 w-11" />}
        ...
        <div className="mt-3.5 flex gap-3 rounded-[16px] border border-[#F6B24B] bg-[#FFF9EF] px-4 py-3.5">
          <div className="flex h-[46px] w-[46px] shrink-0 items-center justify-center rounded-full bg-white text-[#FFA726] shadow-[0_6px_14px_rgba(0,0,0,0.05)]"><ShieldCheckIcon /></div>
          <div>
            <h3 className="text-[15.5px] font-bold leading-tight text-[#18324A]">Профилактика дефицита — лучшая защита от осложнений</h3>
            <p className="mt-1.5 text-[12.5px] font-medium leading-[1.25] text-[#6D7A86]">Своевременный приём витамина D помогает укреплять кости,<br />поддерживать нормальное развитие и защищать здоровье ребёнка<br />с первых дней жизни.</p>
          </div>
        </div>
      </div>
    </>
...
export default function Slide03Complications() {
  ...
  return (
    <section className="relative h-full overflow-hidden px-[35px]" style={{ color: NAVY }}>
      ...
      <div className="absolute left-[35px] top-[1114px] flex h-11 items-center gap-3">
        {stageTabs.map((tab) => {
          ...
          return (
            <button
              key={tab.id}
              type="button"
              className={`h-11 min-w-[190px] cursor-pointer rounded-[12px] px-[22px] text-[16px] font-bold transition duration-200 ease-in-out ${isActive ? 'bg-[#FFA726] text-white shadow-[0_8px_20px_rgba(255,167,38,0.25)]' : 'border border-[#E4E8EB] bg-white text-[#6D7A86] shadow-[0_6px_14px_rgba(0,0,0,0.05)] hover:-translate-y-px hover:shadow-[0_6px_16px_rgba(0,0,0,0.08)]'}`}
